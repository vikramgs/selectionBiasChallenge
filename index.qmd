...
6. **create_meme.py**: Assemble all components into the four-panel meme (**YOU WRITE THIS**) ⚠️
...
6. ⚠️ **Write create_meme.py**: Create `create_meme.py` to assemble the four-panel meme
